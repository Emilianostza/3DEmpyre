...
const MOCK_ASSETS: Asset[] = [
  ...
  },
  {
    ...
    name: 'Negroni',
    project_id: 'PRJ-002',
    thumb: placeholder(400, 400, 'Negroni', 10),
    status: 'Published',
    type: '3D Model',
    size: '2.2 MB',
    file_size: 2_306_000,
    file_key: 'prj-002/negroni.glb',
    content_type: 'model/gltf-binary',
  ...
  },
  {
    ...
    name: 'Whiskey Sour',
    project_id: 'PRJ-002',
    thumb: placeholder(400, 400, 'Whiskey Sour', 70),
    status: 'Published',
    type: '3D Model',
    size: '2.0 MB',
    file_size: 2_097_000,
    file_key: 'prj-002/whiskey-sour.glb',
    content_type: 'model/gltf-binary',
    updated_at: daysAgo(4),
  ...
  },
  {
    ...
    name: 'Mojito',
    project_id: 'PRJ-002',
    thumb: placeholder(400, 400, 'Mojito', 130),
    status: 'Published',
    type: '3D Model',
    size: '1.9 MB',
    file_size: 1_992_000,
    file_key: 'prj-002/mojito.glb',
    content_type: 'model/gltf-binary',
    updated_at: daysAgo(3),
  ...
  },
  {
    ...
    name: 'Aperol Spritz',
    project_id: 'PRJ-002',
    thumb: placeholder(400, 400, 'Aperol Spritz', 50),
    status: 'In Review',
    type: '3D Model',
    size: '2.3 MB',
    file_size: 2_411_000,
    file_key: 'prj-002/aperol-spritz.glb',
    content_type: 'model/gltf-binary',
  ...
  },
  {
    ...
    project_id: 'PRJ-002',
    thumb: placeholder(400, 400, 'Charcuterie', 90),
    status: 'Published',
    type: '3D Model',
    size: '3.7 MB',
    file_size: 3_880_000,
    file_key: 'prj-002/charcuterie-board.glb',
    content_type: 'model/gltf-binary',
    updated_at: daysAgo(3),
    created_at: daysAgo(15),
    viewCount: 1150,
